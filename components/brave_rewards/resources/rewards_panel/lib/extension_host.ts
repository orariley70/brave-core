...
import { createPanelHandler } from './webui_panel_handler'
import { createExtensionPanelHandler, getExtensionString } from './extension_panel_handler'
...
export function createHost (): Host {
  ...
  async function initialize () {
    ...
    panelHandler.startRewards()

    await loadPanelData()

    loadPersistedState()
    handleRewardsPanelArgs((await panelHandler.getRewardsPanelArgs()).args)
