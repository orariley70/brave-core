...
class PanelHandlerImpl : public brave_rewards::mojom::PanelHandler,
 ...
 public:
  PanelHandlerImpl(
      ...
      mojo::PendingRemote<brave_rewards::mojom::PanelUIHandler> ui_handler,
  ...
  void GetRewardsPanelArgs(GetRewardsPanelArgsCallback callback) override {
    auto* panel_service = RewardsPanelServiceFactory::GetForProfile(profile_);
    std::move(callback).Run(
        panel_service ? panel_service->panel_args().Clone()
  ...
  void OnRewardsPanelRequested(
    ...
    if (ui_handler_) {
      ui_handler_->OnRewardsPanelRequested(args.Clone());
    }
  }

 private:
  mojo::Receiver<brave_rewards::mojom::PanelHandler> receiver_;
  mojo::Remote<brave_rewards::mojom::PanelUIHandler> ui_handler_;
