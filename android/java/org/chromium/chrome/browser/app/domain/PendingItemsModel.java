...
public class PendingItemsModel {
    ...
    public PendingItemsModel(KeyringService mKeyringService, JsonRpcService mJsonRpcService,
            BraveWalletService mBraveWalletService, PendingTxHelper mPendingTxHelper) {
        this.mKeyringService = mKeyringService;
        this.mBraveWalletService = mBraveWalletService;
        this.mJsonRpcService = mJsonRpcService;
        this.mPendingTxHelper = mPendingTxHelper;
    }
